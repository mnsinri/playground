...
export const GitProIcon: React.FC<
  {
    width: string | number;
...
> = ({ width, height, ...Props }) => {
  ...
  return (
    <motion.svg
      ...
      animate={{
        opacity: 1,
        transition: { delay: 0.5, duration: 1, ease: [0.15, 0.3, 0.6, 0.95] },
      }}
      version="1.0"
    ...
    >
      <motion.g
        ...
        fill={themes.dark.main}
        stroke={themes.dark.character}
      >
        <motion.circle
          cx="2560"
          cy="2500"
          r="2200"
          fill={themes.dark.character}
        />

        <motion.path
          d="M2319 4540 c-378 -48 -741 -200 -1028 -430 -396 -319 -643 -730 -741
...
591 -88 18 -154 23 -325 25 -118 2 -245 0 -281 -5z"
        />
        <motion.path
          d="M1935 3008 c-224 -43 -386 -272 -348 -494 33 -188 178 -333 366 -365
...
29 222 23 299 -13z"
        />
        <motion.path
          d="M2402 2175 c-23 -13 -72 -49 -107 -79 -85 -72 -124 -84 -204 -64 -35
